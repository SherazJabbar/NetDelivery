...
export const Navbar = () => {
  ...
  const showBlackCart = location.pathname === "/pickup";
  // const showWhiteCart = location.pathname === "/pickup;"
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 bg-white  ${
        isScrolled ? "shadow-md" : "bg-opacity-0"
      }`}
    >
        ...
        <div className="flex space-x-2 md:space-x-4 items-center">
          ...
          {showBlackCart && (
            <div className="hidden md:block">
              <img src={CartBlack} alt="Add to Cart" className="w-8 mr-2" />
            </div>
          )}
      ...
      <div className="flex justify-between px-4 pb-4 items-center md:hidden">
        {showSearch && (
